...
function ActivityDetailsModal({ isOpen, onClose, title, description, projectTheme }) {
  ...
  return (
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center p-4 ${isOpen ? "animate-in fade-in duration-300" : "animate-out fade-out duration-300 fill-mode-forwards"}`}>
      ...
      {/* Modal Content */}
      <div className={`relative w-full max-w-2xl max-h-[85vh] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden ${isOpen ? "animate-in zoom-in-95 duration-300" : "animate-out zoom-out-95 duration-300 fill-mode-forwards"}`}>
